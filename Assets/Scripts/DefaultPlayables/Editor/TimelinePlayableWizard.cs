    ...
    */
    ...
    string TrackAssetScript ()
    {
        return 
            ...
            "\n" +
            "[TrackColor(" + trackColor.r.ToString(CultureInfo.InvariantCulture).Replace(",",".") + "f, " + trackColor.g.ToString(CultureInfo.InvariantCulture).Replace(",",".") + "f, " + trackColor.b.ToString(CultureInfo.InvariantCulture).Replace(",",".") + "f)]\n" +
