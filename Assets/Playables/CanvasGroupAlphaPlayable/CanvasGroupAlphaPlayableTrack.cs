...
[TrackColor(0.2783019f, 0.639151f, 1f)]
[TrackClipType(typeof(CanvasGroupAlphaPlayableClip))]
[TrackBindingType(typeof(CanvasGroup))]
public class CanvasGroupAlphaPlayableTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<CanvasGroupAlphaPlayableMixerBehaviour>.Create (graph, inputCount);
    }
