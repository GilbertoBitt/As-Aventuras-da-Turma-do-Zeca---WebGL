...
[TrackClipType(typeof(ImageComponent_AlphaPlayableClip))]
[TrackBindingType(typeof(Image))]
public class ImageComponent_AlphaPlayableTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<ImageComponent_AlphaPlayableMixerBehaviour>.Create (graph, inputCount);
    }
